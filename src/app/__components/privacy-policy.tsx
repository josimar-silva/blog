        ...
        <div className="space-y-8">
          ...
          <div className="prose prose-gray max-w-none dark:prose-invert lg:prose-lg space-y-8">
            ...
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">I use the information I collect to:</p>
              <ul className="space-y-2 text-muted-foreground">
            ...
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                I may use analytics services (such as Google Analytics) to understand how visitors use the website.
                These services may collect information about your visit, including pages viewed, time spent, and
                referring sites.
              </p>

              <h3 className="text-xl font-semibold mb-3">Hosting and CDN</h3>
              <p className="text-muted-foreground leading-relaxed mb-4">
                This website is hosted on Vercel, which may collect technical information about your visit. Please
                review Vercel's privacy policy for more information.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed">
                I retain personal information only as long as necessary to fulfill the purposes outlined in this privacy
                policy, unless a longer retention period is required or permitted by law. Contact information from
                inquiries is typically retained for up to 2 years.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-muted-foreground">
                <li>• Access: Request a copy of the personal information I hold about you</li>
            ...
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                information from children under 13. If I become aware that I have collected personal information from a
                child under 13, I will take steps to delete such information.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                updated "Last updated" date. I encourage you to review this policy periodically for any changes.
              </p>
            </div>
