          ...
          <div className="prose prose-gray max-w-none dark:prose-invert lg:prose-lg space-y-8">
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed">
                By accessing and using this website (johndoe.dev), you accept and agree to be bound by the terms and
            ...
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed mt-4">
                ...
                terminated by me at any time. Upon terminating your viewing of these materials or upon the termination
            ...
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                The blog posts and articles on this website are my original work unless otherwise noted. You may:
              </p>
              <ul className="space-y-2 text-muted-foreground">
                <li>• Share links to articles with proper attribution</li>
                <li>• Quote brief excerpts with proper attribution and links back to the original</li>
                <li>• Use the content for educational or research purposes with proper citation</li>
              </ul>

              <h3 className="text-xl font-semibold mb-3 mt-6">Code Examples</h3>
              <p className="text-muted-foreground leading-relaxed">
                Code examples and snippets shared in blog posts are provided for educational purposes and may be used
                freely in your projects, though attribution is appreciated.
              </p>
            </div>

            <div>
              <h2 className="text-2xl font-bold mb-4">User Conduct</h2>
              <p className="text-muted-foreground leading-relaxed mb-4">When using this website, you agree not to:</p>
              <ul className="space-y-2 text-muted-foreground">
                ...
                <li>
                  • Infringe upon or violate my intellectual property rights or the intellectual property rights of
                  others
                </li>
            ...
            <div>
              <h2 className="text-2xl font-bold mb-4">Comments and User-Generated Content</h2>
              <p className="text-muted-foreground leading-relaxed mb-4">
                If this website allows comments or other user-generated content in the future:
              </p>
              <ul className="space-y-2 text-muted-foreground">
                <li>• You retain ownership of content you submit</li>
                <li>• You grant me a non-exclusive license to use, modify, and display your content</li>
                <li>• You are responsible for the content you submit</li>
                <li>• I reserve the right to remove any content at my discretion</li>
            ...
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed">
                Further, I do not warrant or make any representations concerning the accuracy, likely results, or
            ...
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed">
                In no event shall John Doe or its suppliers be liable for any damages (including, without limitation,
                damages for loss of data or profit, or due to business interruption) arising out of the use or inability
                to use the materials on this website, even if I or my authorized representative has been notified orally
            ...
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                I do not warrant that any of the materials on its website are accurate, complete, or current. I may make
                changes to the materials contained on its website at any time without notice. However, I do not make any
            ...
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed">
                I have not reviewed all of the sites linked to this website and am not responsible for the contents of
                any such linked site. The inclusion of any link does not imply endorsement by me of the site. Use of any
            ...
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed">
                I may revise these terms of service for its website at any time without notice. By using this website,
